...
+ "{buy:{id:\"minecraft:diamond\",count:4b},sell:{id:\"minecraft:iron_helmet\",count:1b,components:{\"minecraft:unbreakable\":{}, \"minecraft:attribute_modifiers\":{modifiers:[{type:\"minecraft:generic.knockback_resistance\",amount:0.2d,operation:\"add_value\",slot:\"head\"}]}}}},"
+ "{buy:{id:\"minecraft:diamond\",count:7b},sell:{id:\"minecraft:iron_chestplate\",count:1b,components:{\"minecraft:unbreakable\":{}, \"minecraft:attribute_modifiers\":{modifiers:[{type:\"minecraft:generic.knockback_resistance\",amount:0.4d,operation:\"add_value\",slot:\"chest\"}]}}}},"
